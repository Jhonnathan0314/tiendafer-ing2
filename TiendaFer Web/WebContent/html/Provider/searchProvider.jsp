...
<body class="background">
        ...
        <form action="Servlet?menu=Provider" method="post" class="container">
                ...
                <input type="text" class="dataField" name="txtSearchNit">

                <h3 class="textField">Digite el nombre del proveedor</h3>
                <input type="text" class="dataField" name="txtSearchSupplierName">

                <h3 class="textField">Digite el nombre del vendedor</h3>
                <input type="text" class="dataField" name="txtSearchSellerName">
