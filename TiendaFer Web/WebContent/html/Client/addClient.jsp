...
<body class="background">
        <div class="buttonContainer">
            ...
            <a href="Servlet?menu=Bil&action=searchAlll">
			...
			<form action="Servlet?menu=Client" method="post" class="container">
                ...
                <h3 class="textField">Digite la cedula del cliente</h3>
                <input type="number" class="dataField" name="txtNewDni">

                <h3 class="textField">Digite el nombre del cliente</h3>
                <input type="text" class="dataField" name="txtNewClientName">
